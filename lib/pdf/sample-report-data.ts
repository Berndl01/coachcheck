...
export const SAMPLE_REPORT: ReportOutput = {
  ...
  fuehrungsreife_interpretation:
    'Diese sechs Entwicklungsindikatoren sind ein Reflexionsraster aus deinen Antworten — kein normiertes Reifemaß, sondern Hinweise, wo genaueres Hinsehen lohnt. Deutlich ausgeprägt zeigt sich die Verantwortungsklarheit: Du weißt, wofür du stehst, und triffst Entscheidungen ohne Schlingern. Auch Selbstregulation und Druckreife liegen im oberen Bereich und deuten an, dass dich enge Phasen verlässlich tragen. Im mittleren Bereich liegt die Perspektivflexibilität — die Fähigkeit, bewusst die Sicht deiner Spieler einzunehmen und deinen Stil daran anzupassen. Lies das als Anstoß, nicht als Urteil: Genau dort könnte ein Hebel liegen, um deine Führung anschlussfähiger zu machen.',
  no_go_warnungen: [
