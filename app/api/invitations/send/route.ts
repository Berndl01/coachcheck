        ...
        <div style="font-family: -apple-system, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; color: #1B1C1E;">
          ...
          <div style="padding: 32px 0;">
            ...
            <h1 style="font-size: 28px; font-weight: 300; letter-spacing: -0.5px; line-height: 1.2; margin: 0 0 16px 0;">
              ${trainerName} bittet dich um deine Sicht.
            </h1>
            <p style="font-size: 15px; line-height: 1.55; color: #767471; margin-bottom: 18px;">
              ${trainerName} macht gerade ein Premium-Trainer-Assessment auf <strong>Humatrix Coach</strong>${sport ? ` (${sport})` : ''}
              und möchte verstehen, wie du ${trainerName.split(' ')[0]} als Trainer wirklich erlebst.
            </p>
            <p style="font-size: 15px; line-height: 1.55; color: #767471; margin-bottom: 28px;">
              Deine Einschätzung ist <strong style="color: #1B1C1E;">100% anonym</strong>. ${trainerName.split(' ')[0]} sieht nie, wer was geantwortet hat —
